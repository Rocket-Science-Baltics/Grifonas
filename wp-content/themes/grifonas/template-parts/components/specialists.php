    ...
    <div class="container">
        <div class="grid grid-cols-3 gap-x-[19px]">
            ...
            <?php foreach ($content_sections as $section): ?>
                <div class="<?php echo $section['section_paragraph']['enable_breakline'] ? 'paragraph-w-breakline' : ''; ?> section-content mt-[46px] px-[33px] py-[35px] bg-<?php echo $section['section_paragraph']['paragraph_background']; ?> rounded-[8px]">
